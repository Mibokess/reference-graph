<div class="w-full h-full flex flex-col justify-center" id="graphDiv">
<div>Testest</div>
</div>

<svelte:head>
  <script type="application/javascript" src="https://www.yasiv.com/scripts/vivagraph.js?v=0.8.1" on:load={externalJSLoaded}></script>
</svelte:head>

<script>
    import { onMount } from 'svelte';
    let externalJSReady = false;
    let mounted = false;
